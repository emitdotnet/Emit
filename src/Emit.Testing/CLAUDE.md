...
| `BatchSinkConsumer.cs` | Generic IBatchConsumer implementation that captures each batch into a MessageSink for test assertions | Register as the batch consumer in test DI configuration |
