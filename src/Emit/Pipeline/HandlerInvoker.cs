...
/// and invokes it with the inbound context.
/// </summary>
/// <typeparam name="TValue">The message value type.</typeparam>
public sealed class HandlerInvoker<TValue>(Type consumerType) : IHandlerInvoker<InboundContext<TValue>>
{
    /// <inheritdoc />
    public async Task InvokeAsync(InboundContext<TValue> context)
    {
