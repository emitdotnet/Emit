...
| `ActivityPropagation.cs` | Helper utilities for creating and managing OpenTelemetry activities | Create custom activities or understand activity lifecycle |
...
| `OutboxActivityFactory.cs` | Helpers for creating and managing tracing activities during outbox processing | Understand outbox tracing or debug outbox activity creation |
