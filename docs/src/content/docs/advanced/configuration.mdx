...
| `QueuedMaxMessagesKbytes` | Maximum KB of pre-fetched messages in the local consumer queue. Critical for memory-constrained containers where librdkafka's 1 GB default can cause OOM-kills. |
