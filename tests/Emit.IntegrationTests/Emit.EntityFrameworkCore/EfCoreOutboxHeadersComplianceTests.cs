...
/// <summary>
/// EF Core (PostgreSQL) + Kafka implementation of <see cref="OutboxHeadersCompliance"/>.
/// Verifies that custom headers round-trip through the EF Core transactional outbox and Kafka.
/// </summary>
[Trait("Category", "Integration")]
public class EfCoreOutboxHeadersComplianceTests
    : OutboxHeadersCompliance,
      ...
      IClassFixture<KafkaContainerFixture>
{
    ...
    public EfCoreOutboxHeadersComplianceTests(
        ...
        KafkaContainerFixture kafkaFixture)
    {
        ...
        databaseName = $"emit_headers_{Guid.NewGuid():N}"[..30];
    ...
    /// <inheritdoc/>
    protected override async Task ProduceWithHeadersAsync(
